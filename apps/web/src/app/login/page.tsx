...
export default async function LoginPage({
  ...
  return (
    <main className="relative flex min-h-dvh items-center justify-center overflow-hidden px-6">
      ...
      <section className="relative z-10 flex w-full max-w-sm flex-col items-center gap-7 rounded-luc-xl border border-luc-border bg-luc-surface-1/85 px-8 py-10 text-center backdrop-blur-md">
        <Logo size={48} />
