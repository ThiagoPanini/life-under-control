...
class InMemoryUserRepo:
    ...
    async def get_by_google_email(self, google_email: str) -> User | None:
        ...
        return next(
            (user for user in self._store.values() if (user.google_email or "").lower() == target),
            None,
        )
